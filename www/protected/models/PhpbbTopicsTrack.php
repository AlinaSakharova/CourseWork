 ...
 *
 * The followings are the available columns in table 'phpbb_topics_track':
 * @property integer $user_id
 * @property integer $topic_id
 * @property integer $forum_id
 * @property string $mark_time
 */
class PhpbbTopicsTrack extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, topic_id, forum_id, mark_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PhpbbTopicsTrack the static model class
	 */
