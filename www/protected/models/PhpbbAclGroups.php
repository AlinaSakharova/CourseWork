 ...
 *
 * The followings are the available columns in table 'phpbb_acl_groups':
 ...
 */
class PhpbbAclGroups extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('group_id, forum_id, auth_option_id, auth_role_id, auth_setting', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('group_id, forum_id, auth_option_id, auth_role_id, auth_setting', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PhpbbAclGroups the static model class
	 */
