...
/**
 * This is the model class for table "spec_position".
 *
 * The followings are the available columns in table 'spec_position':
...
class SpecPosition extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::HAS_MANY, 'User', 'id_position'),
		);
	}
