 ...
 *
 * The followings are the available columns in table 'phpbb_acl_roles_data':
 * @property integer $role_id
 * @property integer $auth_option_id
 * @property integer $auth_setting
 */
class PhpbbAclRolesData extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('role_id, auth_option_id, auth_setting', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('role_id, auth_option_id, auth_setting', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PhpbbAclRolesData the static model class
	 */
